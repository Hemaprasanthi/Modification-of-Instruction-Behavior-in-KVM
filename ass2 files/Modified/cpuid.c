...
/* #include "my_vmx_cpuid_adapter.c" */
...
int kvm_emulate_cpuid(struct kvm_vcpu *vcpu)
{
	...
	/* kvm_cpuid(vcpu, &eax, &ebx, &ecx, &edx, true); */
        ...
        {
            /*
            kvm_register_write(vcpu, VCPU_REGS_RAX, exit_counter);
            kvm_register_write(vcpu, VCPU_REGS_RCX, exit_delta_tsc &0xffffffff);
            kvm_register_write(vcpu, VCPU_REGS_RBX,
                (exit_delta_tsc >> 32) & 0xffffffff);
            */
	   // kvm_cpuid(vcpu, &eax, &ebx, &ecx, &edx, true);
            ...
            */
            ...
            /*
            eax = pass_exit_counter();
            ecx = pass_delta_tsc() & 0xfffffff;
            ebx = (pass_delta_tsc() >> 32) & 0xfffffff;
            */
        }
